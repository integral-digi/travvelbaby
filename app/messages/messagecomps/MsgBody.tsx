    ...
    <div className="w-full h-fit border-l border-gray-400 border-opacity-20"> 
      <div className="w-full h-full pt-8 px-8 pb-4 space-y-4">
        {msgData[id].conversation.map((msg) => (
          <div key={msg.id} className={msg.role === "receiver" ? "w-[60%] space-y-4 float-left clear-both lg:w-[90%]" : "w-[96%] float-right clear-both lg:w-[90%]"}>  
            <div className="w-fit h-auto">
              {Array.isArray(msg.message) ? ( // Checking if this is an image array
                ...
                <div className="w-fit shadow-sm bg-neutral-50 rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl p-6">
        ...
        { msgData[id].isTyping && 
          <div className="w-fit shadow-sm bg-neutral-50 rounded-tl-2xl rounded-tr-2xl rounded-bl-2xl p-8 float-right right-0 clear-both">
