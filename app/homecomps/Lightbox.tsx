    ...
    <div className="w-full">
      {isOpen && (
        <div className="fixed top-0 w-[50%] h-fit flex items-center justify-center z-50 aspect-auto m-auto lg:w-full lg:h-full lg:block">
          ...
          <div className="lightbox-overlay fixed top-0 left-0 w-full h-full bg-black opacity-80"></div>
          <div className="lightbox rounded-lg h-screen relative">
            ...
            {media.endsWith(".mp4") ? (
              ...
              <img src={media} alt="lightbox" className="w-full" />
            )}
