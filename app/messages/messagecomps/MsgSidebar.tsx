...
const recentMessages: MsgSidebarProps[] = [
    ...
    { id: 3, user: "jane", lastMsg: "Hi, how you doing today? I just supported your getaway with.....", avatar: "/media/6u.jpg", time: "37 mins ago", isActive: false, isTyping: false, unreadCount: 1 },
    ...
    { id: 5, user: "nina", lastMsg: "Hi, how you doing today? I just supported your getaway with.....", avatar: "/media/2u.jpg", time: "7 hrs ago", isActive: true, isTyping: false, unreadCount: 2 },
    { id: 6, user: "maryliu", lastMsg: "Hi, how you doing today? I just supported your getaway with.....", avatar: "/media/2u.jpg", time: "8 hrs ago", isActive: false, isTyping: false, unreadCount: 0 },
    ...
    { id: 8, user: "nynaeve", lastMsg: "Hi, how you doing today? I just supported your getaway with.....", avatar: "/media/5u.jpg", time: "1d ago", isActive: true, isTyping: false, unreadCount: 7 },
];
      ...
      <div className="block space-y-10 w-full">
        <div className="w-full space-y-10">
          ...
          <div className="flex items-center space-x-4 pr-8">
            ...
            <img src="/assets/search.svg" alt="search" className="w-5 h-5 absolute top-4 right-4" />
          </div>
        </div>
              ...
              <div className="pr-4 py-8 w-full relative">
                <div className="flex items-center space-x-4 w-max">
                  <span className="relative block">
                   ...
                   {msg.isActive ? <span className="absolute bottom-0 right-0 w-4 h-4 bg-red-500 rounded-full" data-testid={`active-indicator-${index}`} /> : null}
                  </span>
